...
if phase_cycling:
    ...
    fl.plot(data_slice.C.mean('nScans'), alpha=0.5)
    fl.plot(data_slice.C.mean('nScans').imag, alpha=0.5)
    fl.plot(abs(data_slice.C.mean('nScans')), color='k', alpha=0.5)
